...
class PatternExtractor:
    ...
    def visualize_representative_patterns(self, timeframe, representatives, grid_rows=10, grid_cols=10):
        ...
        """
        visualization_dir = os.path.join(self.output_dir, 'visualizations', timeframe)
        ...
        for label, rep in representatives.items():
            ...
            # Save visualization
            file_path = os.path.join(visualization_dir, f"cluster_{label}_pattern.png")
            ...
            candle_file_path = os.path.join(visualization_dir, f"cluster_{label}_candlestick.png")
